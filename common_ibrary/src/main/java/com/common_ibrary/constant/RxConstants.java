...
public class RxConstants {
     ...
     * 微信AppId
     */
    public static final String WxAppId = "wx0e445f1e8ab78e3e";
    public static final String WxPackageValue = "Sign=WXPay";

    /**
     * H5地址
     */
    public static final String H5 = "http://prod.jinshw.cn/";

    /**
     * 状态栏0：为透明1：为不透明
     */
    public static final int BRIGHT = 0;
    public static final int NO_BRIGHT = 1;

    /**
     * EventBus
     */
    public static final int EventOther = 0x111111;
    public static final int EventDefault = 0x000000;


    /**
     * WebViewHeight
     */
    public static final int WebViewHeight = 2;
     ...
     * 正则：6-12位密码
     */
    public static final String REGEX_PSW = "^(?![0-9]*$)(?![a-zA-Z]*$)[a-zA-Z0-9]{8,20}$";
    /**
